...
{
	class MemoriesTableController : ApiController
	{
		private readonly AmazonDynamoDBClient _client;
		public MemoriesTableController() : this(new LocalClientContext())
		{
		}

		public MemoriesTableController(AmazonDynamoDBClient client)
		{
			_client = client;
		}
