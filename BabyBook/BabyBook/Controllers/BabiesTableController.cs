...
{
	class BabiesTableController : ApiController
	{
		private readonly AmazonDynamoDBClient _client;
		public BabiesTableController() : this(new LocalClientContext())
		{
		}

		public BabiesTableController(AmazonDynamoDBClient client)
		{
			_client = client;
		}
